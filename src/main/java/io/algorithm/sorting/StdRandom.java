 ...
 * array <code>a[]</code>, starting at index <code>lo</code> (inclusive) and ending at index
 * <code>hi</code> (exclusive).
 * <p>
 * For additional documentation, see <a href="https://introcs.cs.princeton.edu/22library">Section
 * 2.2</a> of
