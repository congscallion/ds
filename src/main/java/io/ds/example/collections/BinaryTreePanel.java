...
public class BinaryTreePanel extends JPanel {
  ...
  /**
   * Draws the tree in the panel.  First it computes the coordinates of all the nodes with an
   * inorder traversal, then draws them with a postorder traversal.
   */
  ...
  /**
   * Returns a color for the node.  If the node is of a class with a field called "color", and that
   * field currently contains a non-null value, then that value is returned.  Otherwise a default
   * color of yellow is returned.
   */
