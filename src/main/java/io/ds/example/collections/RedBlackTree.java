...
public class RedBlackTree extends BinarySearchTree {
  ...
  /**
   * Constructs an empty RedBlackTree that orders its items according to the given comparator.
   */
   ...
   * equal to the item being inserted, it is "overwritten" by the new item. Overrides
   * BinarySearchTree.add because the tree needs to be adjusted after insertion.
   */
  ...
  /**
   * Classic algorithm for fixing up a tree after removing a node; the parameter to this method is
   * the node that was pulled up to where the removed node was.
   */
  ...
  /**
   * The nodes in a red-black tree store a color together with the actual data in the node.
   */
