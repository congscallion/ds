...
/**
 * A little application that lets you interactively manipulate a binary search tree.
 */
public class BinarySearchTreeViewer extends JFrame {
  ...
  /**
   * Constructs a viewer, laying out all the components in a very nice way, and constructs and
   * registers all the operation objects.
   */
  ...
  /**
   * An operation encapsulates a button and its action.  The constructor will create a button, add
   * it to a button panel, and register itself as a listener for the button.  The listener first
   * reads inputs from a textfield, then calls a subclass-supplied method with those inputs, then
   * displays the resulting tree in the display area.
   */
